...
function moveBox) {
let box - document. getElementById ("movingBox"); let position - 0;
...
const hoverText - document. gettlementById("hoverText");
...
const formMessage - document.getlementById(" formMessage");
if ( name === "" || membership === "") {
forMessage.innerHTML = " Please complete all form fields. ";
